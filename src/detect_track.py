...
def classNames():
    cocoClassNames = ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat",
                  ...
                  "baseball glove", "skateboard", "surfboard", "paddle", "bottle", "wine glass", "cup",
...
def draw_boxes(frame, bbox_xyxy, draw_trails, identities=None, categories=None, offset=(0,0)):
    ...
    for i, box in enumerate(bbox_xyxy):
        ...
        name = className[cat]
        label = str(id) + ":" + name
        text_size = cv2.getTextSize(label, 0, fontScale=0.75, thickness=2)[0]
        ...
        if draw_trails:
              ...
              for i in range(1, len(data_deque[id])):
                  ...
                  thickness = int(np.sqrt(128 / float(i + i)) * 1.5)
                  # draw trails
